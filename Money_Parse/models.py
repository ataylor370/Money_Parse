import uuid
from django.db import models # Imports the building blocks for defining database
from django.contrib.auth.models import User # Brings in Django's built-in User model for authentication
import datetime
